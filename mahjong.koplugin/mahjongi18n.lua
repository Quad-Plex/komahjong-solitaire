...
local CATALOG = {
    en = {
        ...
        ["help.characters"] = "Characters, dots and bamboo: match the same number and suit.",
        ["help.winds"] = "Winds: match identical winds.", ["help.dragons"] = "Dragons: match identical dragons.",
        ["help.flowers"] = "Flowers: any flower matches any flower.", ["help.seasons"] = "Seasons: match any season.",
