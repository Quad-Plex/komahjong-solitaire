...
local CATALOG = {
    en = {
        ...
        ["game.cleared"] = "You cleared the board!", ["game.new_best"] = "(New best!)",
         ...
         ["game.best_combo"] = "Best combo achieved",
    ...
    de = {
        ...
        ["help.features"] = "Funktionen", ["help.created_by"] = "Erstellt von @Quad-Plex", ["help.page_one_1"] = "Entferne alle Steine zum Gewinnen. Wähle zwei freie Steine aus",
        ["help.page_one_2"] = "um sie zu entfernen. Freie Steine werden von keinem anderen Stein ", ["help.page_one_3"] = "bedeckt. Außerdem ist ihre rechte oder linke Seite vollständig",
