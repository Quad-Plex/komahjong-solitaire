...
local CATALOG = {
    ...
    de = {
        ...
        ["help.features"] = "Funktionen", ["help.created_by"] = "Erstellt von @Quad-Plex", ["help.page_one_1"] = "Entferne alle Steine zum Gewinnen. Wähle zwei passende Steine die",
        ["help.page_one_2"] = "frei sind, um sie zu entfernen. Freie Steine werden von keinem anderen Stein ", ["help.page_one_3"] = "bedeckt. Ausserdem ist ihre rechte oder linke Seite vollständig",
