...
local CATALOG = {
    en = {
        ...
        ["settings.chain"] = "Chain/Combo", ["settings.interaction"] = "On interaction",
        ...
        ["help.chain_method"] = "the score method is Chain. Combos only apply",
        ["help.chain_method_2"] = "in Chain mode; Basic has no bonuses.",
    ...
    de = {
        ...
        ["settings.basic"] = "Einfach", ["settings.chain"] = "Kette/Kombo",
        ...
        ["help.chain_method"] = "die Punktemethode Kette ist. KOMBOs gelten nur im Kette-Modus;",
        ["help.chain_method_2"] = "Einfach hat keine Boni.", ["help.combo_1"] = "Finde innerhalb von 5 Sekunden ein weiteres Paar für eine",
