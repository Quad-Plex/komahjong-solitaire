...
local CATALOG = {
    en = {
        ...
        ["settings.off"] = "Off", ["settings.basic"] = "Basic",
        ["settings.chain"] = "Chain (+5 bonus)", ["settings.interaction"] = "On interaction",
        ["settings.periodic"] = "Periodic", ["settings.seconds"] = "%d s",
        ["settings.hints"] = "Hints", ["settings.timer_update"] = "Timer update",
        ...
        ["stats.best_time"] = "Best time", ["stats.average_time"] = "Average time per win",
        ...
        ["game.time"] = "Time", ["game.pairs_matched"] = "Pairs matched",
        ...
        ["help.page_one_1"] = "Remove all tiles to win. Select two matching tiles",
        ["help.page_one_2"] = "that are free.", ["help.page_one_3"] = "Free tiles have no tile covering them.",
        ["help.page_one_4"] = "They also have a fully open right or left side,",
        ["help.page_one_5"] = "with no tile covering any part of it.",
        ...
        ["help.characters"] = "Characters, dots and bamboo: match the same number\nand suit.",
        ["help.winds"] = "Winds: match identical winds.", ["help.dragons"] = "Dragons: match identical dragons.",
        ["help.flowers"] = "Flowers: any flower matches\nany flower.", ["help.seasons"] = "Seasons: match any season.",
        ["help.each_pair"] = "Each pair scores 10 points.",
        ["help.chain_bonus"] = "A same-group chain bonus adds 5 points when",
        ["help.chain_method"] = "the score method is Chain.",
    ...
    de = {
        ...
        ["settings.basic"] = "Einfach", ["settings.chain"] = "Kombo (+5 Bonus)",
        ["settings.interaction"] = "Bei Interaktion", ["settings.periodic"] = "Periodisch",
        ["settings.seconds"] = "%d s", ["settings.hints"] = "Tipps", ["settings.timer_update"] = "Timer-Aktualisierung",
        ...
        ["game.congrats_overall_time"] = "Glückwunsch! Neuee Gobale Bestzeit!",
        ["game.congrats_layout_score_time"] = "Glückwunsch! Neue Bestzeit und -punktzahl auf diesem Layout!",
        ...
        ["game.time"] = "Zeit", ["game.pairs_matched"] = "Gefundene Paare",
        ["game.overall_best_score"] = "Bester Gesamtpunktestand", ["game.overall_best_time"] = "Beste Gesamtzeit",
        ["game.current_streak"] = "Aktuelle Serie", ["game.hints_used"] = "Verwendete Tipps",
        ...
        ["help.characters"] = "Zeichen, Punkte und Bambus: gleiche Zahl und gleiche Farbe.",
        ["help.winds"] = "Winde: gleiche Winde paaren.", ["help.dragons"] = "Drachen: gleiche Drachen paaren.",
        ["help.flowers"] = "Blumen: beliebige Blumen passen zusammen.", ["help.seasons"] = "Jahreszeiten: beliebige Jahreszeiten paaren.",
        ["help.each_pair"] = "Jedes Paar bringt 10 Punkte.", ["help.chain_bonus"] = "Eine Ketten-Serie derselben Gruppe bringt 5 Punkte, wenn",
        ["help.chain_method"] = "die Punktemethode Kette ist.", ["help.combo_1"] = "Finde innerhalb von 5 Sekunden ein weiteres Paar für eine",
